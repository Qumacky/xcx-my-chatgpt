...
var en$1 = {
	"myChatGPT.entry.name": "My ChatGPT",
	"myChatGPT.entry.description": "Description of this extension"
};
var ja$1 = {
	"myChatGPT.entry.name": "My ChatGPT",
	"myChatGPT.entry.description": "拡張機能の説明"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"myChatGPT.entry.name": "My ChatGPT",
	"myChatGPT.entry.description": "かくちょうきのうのせつめい"
}
};
...
var entry = {
  get name() {
    return formatMessage$1({
      id: 'myChatGPT.entry.name',
      default: 'My ChatGPT',
      description: 'name of the extension'
    });
  },
  extensionId: 'myChatGPT',
  extensionURL: 'https://Qumacky.github.io/xcx-my-chatgpt/dist/myChatGPT.mjs',
  ...
  get description() {
    return formatMessage$1({
      ...
      id: 'myChatGPT.entry.description'
    });
  },
  featured: true,
  disabled: false,
  ...
  helpLink: 'https://Qumacky.github.io/xcx-my-chatgpt/',
...
var en = {
	"myChatGPT.name": "My ChatGPT",
	"myChatGPT.doIt": "do it [SCRIPT]"
};
var ja = {
	"myChatGPT.name": "My ChatGPT",
	"myChatGPT.doIt": "[SCRIPT] を実行する"
};
var translations = {
	en: en,
	ja: ja,
 ...
 * @type {string}
 */
var extensionURL = 'https://Qumacky.github.io/xcx-my-chatgpt/dist/myChatGPT.mjs';
...
var ExtensionBlocks = /*#__PURE__*/function () {
  /**
   * Construct a set of blocks for My ChatGPT.
  ...
  _createClass(ExtensionBlocks, [{
    ...
    value: function getInfo() {
      ...
      return {
        ...
        blocks: [{
          ...
          blockType: blockType.COMMAND,
          text: 'temperature を設定 (0-2) [NUMBER]',
          arguments: {
            NUMBER: {
              type: argumentType.NUMBER,
    ...
    value: function answer(args) {
      var _this = this;
      if (this.apiKey === 'API キー' || this.apiKey === '') {
      ...
      var params = {
        ...
        body: JSON.stringify({
          model: "gpt-3.5-turbo",
          messages: [].concat(_toConsumableArray(this.messageLogs), [questionMessageLog]),
          max_tokens: this.maxTokens,
          temperature: this.temperature
        })
      };
      var completionPromise = fetchWithTimeout_1('https://api.openai.com/v1/chat/completions', params, this.timeout).then(function (response) {
        return response.json();
      }).then(function (json) {
        if (json.error !== undefined) {
          return "[".concat(json.error.code, ": ").concat(json.error.type, "] ").concat(json.error.message);
        }
        _this._lastAnswer = json.choices[0].message.content;
        _this._lastQuestion = question;
        _this.messageLogs.push(questionMessageLog);
        _this.messageLogs.push({
          role: "assistant",
          content: _this._lastAnswer
        });
        return _this._lastAnswer;
      }).catch(function (error) {
        log.warn(error);
        return '答えを取得できませんでした'.concat(" | ", error);
      });
      return completionPromise;
    }
  }, {
    key: "clearMessageLogs",
    value: function clearMessageLogs() {
      this._lastAnswer = '';
      this._lastQuestion = '';
      this._initMessageLog();
    }
    ...
    key: "setTemperature",
    value: function setTemperature(args) {
